...
class ReparamLargeKernelConv(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size,
        ...
        if small_kernel == 1000:
            self.small_kernel = None
        self.LoRA = LoRA
...
@register_model
def convnext_tiny_Rep_py(pretrained=False, **kwargs):
...
@register_model
def convnext_small_Rep_py(pretrained=False, **kwargs):
...
@register_model
def convnext_base_Rep_py(pretrained=False, in_22k=False, **kwargs):
...
@register_model
def convnext_large_Rep_py(pretrained=False, in_22k=False, **kwargs):
...
@register_model
def convnext_xlarge_Rep_py(pretrained=False, in_22k=False, **kwargs):
